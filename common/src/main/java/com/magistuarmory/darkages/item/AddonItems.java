...
//	public static final @Nullable RegistrySupplier<MedievalArmorItem> RICH_BYRNIE_BOOTS = INSTANCE.addMedievalArmorItem("rich_byrnie_boots", AddonArmorTypes.RICH_BYRNIE, ArmorItem.Type.BOOTS, new Item.Properties()); # Not texture.
	...
	public static final RegistrySupplier<DyeableArmorDecorationItem> EARLY_TUNIC_DECORATION = INSTANCE.addDyeableArmorDecorationItem("early_tunic_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(EpicKnightsDarkAges.ID, "early_tunic"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
	public static final RegistrySupplier<DyeableArmorDecorationItem> KLAPPENROCK_TUNIC_DECORATION = INSTANCE.addDyeableArmorDecorationItem("klappenrock_tunic_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(EpicKnightsDarkAges.ID, "klappenrock_tunic"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
	public static final RegistrySupplier<DyeableArmorDecorationItem> SAXON_TUNIC_DECORATION = INSTANCE.addDyeableArmorDecorationItem("saxon_tunic_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(EpicKnightsDarkAges.ID, "saxon_tunic"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
	public static final RegistrySupplier<DyeableArmorDecorationItem> LATE_SAXON_TUNIC_DECORATION = INSTANCE.addDyeableArmorDecorationItem("late_saxon_tunic_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(EpicKnightsDarkAges.ID, "late_saxon_tunic"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
	...
	public static final RegistrySupplier<DyeableArmorDecorationItem> PILE_WOVEN_CLOAK_DECORATION = INSTANCE.addDyeableArmorDecorationItem("pile_woven_cloak_decoration", () -> new DyeableArmorDecorationItem(new ResourceLocation(EpicKnightsDarkAges.ID, "pile_woven_cloak"), new Item.Properties(), ArmorItem.Type.CHESTPLATE));
