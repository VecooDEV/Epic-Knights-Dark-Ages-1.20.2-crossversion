...
public class GorzuchyHelmetModel {
	...
	public static LayerDefinition createLayer() {
		...
		.texOffs(0, 17).addBox(-4.0F, -10.8F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(48, 27).addBox(-1.0F, -12.8F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
