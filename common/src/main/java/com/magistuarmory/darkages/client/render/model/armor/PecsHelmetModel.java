...
public class PecsHelmetModel {
	...
	public static LayerDefinition createLayer() {
		...
		.texOffs(0, 17).addBox(-4.0F, -9.8F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(48, 27).addBox(-1.0F, -11.8F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
